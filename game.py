        ...
        while True:
            ...
            for rect in self.leaf_spawners:
                if random.randint(0, 50000) < rect.width * rect.height:
                    pos = (rect.x + random.randint(0, rect.width), rect.y + random.randint(0, rect.height))
            ...
            for projectile in self.projectiles.copy():
                ...
                if self.tilemap.solid_check(projectile[0]):
                    for i in range(4):
                        self.sparks.append(Spark(projectile[0], math.pi + random.uniform(-0.5, 0.5) + (math.pi if projectile[1] < 0 else 0),
                                                      random.uniform(2, 3)))
                    ...
                    if self.player.rect().collidepoint(projectile[0]):
                        ...
                        for i in range(30):
                            ...
                            self.sparks.append(Spark(self.player.rect().center, angle, random.uniform(2, 3)))
